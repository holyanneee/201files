                ...
                <table class="table student-data-table m-t-20">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo htmlentities($row->unit).'.0';?></td>
                      <td>
                        <span><a href="bsitprog.php?editid=<?php echo htmlentities($row->cid);?>"><i class="ti-pencil-alt color-success"></i></a></span>
                        <span><a href="bsitprog.php?delid=<?php echo ($row->cid);?>" onclick="return confirm('Do you really want to Delete ?');"><i class="ti-trash color-danger"></i></a></span>
                      </td>
                    </tr>
                    <?php $cnt=$cnt+1;}} ?>
                  </tbody>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post">
          ...
          <div class="form-group">
            <label for="ccode">Course Code</label>
            <input type="text" class="form-control" name="ccode" id="ccode" value="<?php echo $row->course_code;?>" required>
          </div>
          <div class="form-group">
            <label for="ctitle">Course Title</label>
            <input type="text" class="form-control" name="ctitle" id="ctitle" value="<?php echo $row->course_title;?>" required>
          </div>
          <div class="form-group">
            <label for="clec">Lecture Hours</label>
            <input type="text" class="form-control" name="clec" id="clec" value="<?php echo $row->Lec;?>" required>
          </div>
          <div class="form-group">
            <label for="clab">Lab Hours</label>
            <input type="text" class="form-control" name="clab" id="clab" value="<?php echo $row->Lab;?>" required>
          </div>
          <div class="form-group">
            <label for="cunit">Unit</label>
            <input type="text" class="form-control" name="cunit" id="cunit" value="<?php echo $row->unit;?>" required>
          </div>
